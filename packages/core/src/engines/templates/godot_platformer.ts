...
func _ready() -> void:
	...
	visual = _build_visual("player", Color("${spec.palette.accent}"), Vector2(22, 30))
	add_child(visual)
...
func _ready() -> void:
	...
	add_child(_build_visual("enemy", Color("#e5484d"), Vector2(26, 26)))
...
export function platformerFiles(spec: GameSpec): Record<string, string | Uint8Array> {
  return {
